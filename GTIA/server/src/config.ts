...
export class Config {
  ...
  'jhipster.mail.from' = 'gtia@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'gtia API';
  'jhipster.swagger.description' = 'gtia API documentation';
  ...
  'eureka.instance.appname' = 'gtia';
  'eureka.instance.instanceId' = 'gtia:${random.value}';
